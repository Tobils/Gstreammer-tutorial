...
/* enumerations from "../../../../gstreamer-1.12.2/libs/gst/controller/gstinterpolationcontrolsource.h" */
GType gst_interpolation_mode_get_type (void);
#define GST_TYPE_INTERPOLATION_MODE (gst_interpolation_mode_get_type())

/* enumerations from "../../../../gstreamer-1.12.2/libs/gst/controller/gstlfocontrolsource.h" */
